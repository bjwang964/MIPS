...
HD_PWD='C:/Users/q1109/Documents/VivadoProject/MIPS32/MIPS32.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ADD32.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ADD32.tcl -notrace
