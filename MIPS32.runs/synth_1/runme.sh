...
HD_PWD='C:/Users/q1109/Documents/VivadoProject/MIPS32/MIPS32.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Instr_Execute.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Instr_Execute.tcl
